...
Circle.prototype.getAnimateType = function() {
    ...
    this.backType = 'back'; // selectType.options[selectType.options.selectedIndex].value;
    this.backDynamics = 'linear'; // selectDynamics.options[selectDynamics.options.selectedIndex].value;
}
// 复位散开
